...
public class SeleniumWebSignupTest {
    ...
    public void SignUp() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("tobi96");
        //6. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("tobi96@gmail.com");
        //7.Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("tobi96");
    ...
    public void negativeSignup() throws InterruptedException {
        ...
        driver.findElement(By.id("user_email")).sendKeys("TOBIFATOKI419@gmail.com");
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("TOBI419");
    ...
    public void negativeSignup1() throws InterruptedException {
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("TOBI419");
        //Test8.Verify that user cannot Sign UP with invalid email address
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("0419@.com");
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("TOBI19");
        //5. Click on Signup button
        driver.findElement(By.id("submit")).click();
        Thread.sleep(5000);
        //6. Click on Login button
    ...
    public void negativeSignup3() throws InterruptedException {
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("tobi321");
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("tobi321@gmail.com");
